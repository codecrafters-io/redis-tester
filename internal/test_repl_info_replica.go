...
func testReplInfoReplica(stageHarness *test_case_harness.TestCaseHarness) error {
	...
	go func(l net.Listener) error {
		// Connecting to master, and performing the handshake is optional in this stage.
	...
	client, err := instrumented_resp_connection.NewInstrumentedRespClient(stageHarness, "localhost:6380", "client")
	if err != nil {
