...
func (t SendReplicationHandshakeTestCase) RunAll(client *resp_connection.RespConnection, logger *logger.Logger) error {
...
func (t SendReplicationHandshakeTestCase) RunPingStep(client *resp_connection.RespConnection, logger *logger.Logger) error {
...
func (t SendReplicationHandshakeTestCase) RunReplconfStep(client *resp_connection.RespConnection, logger *logger.Logger) error {
	commandTest := CommandTestCase{
		Command:   "REPLCONF",
...
func (t SendReplicationHandshakeTestCase) RunPsyncStep(client *resp_connection.RespConnection, logger *logger.Logger) error {
	commandTest := CommandTestCase{
		Command:                   "PSYNC",
		Args:                      []string{"?", "-1"},
...
func (t SendReplicationHandshakeTestCase) RunReceiveRDBStep(client *resp_connection.RespConnection, logger *logger.Logger) error {
